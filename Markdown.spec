...
Source0  : https://files.pythonhosted.org/packages/fd/d6/9eeda2f440ef798c8222b77d7355199345ce3477941d8a02a2024ccb9ed2/Markdown-3.3.3.tar.gz
...
%prep
%setup -q -n Markdown-3.3.3
cd %{_builddir}/Markdown-3.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611279548
...
cp %{_builddir}/Markdown-3.3.3/LICENSE.md %{buildroot}/usr/share/package-licenses/Markdown/686030b6b3298c011fe74266f0cde2d2c77f4a13
