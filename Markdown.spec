...
Source0  : https://files.pythonhosted.org/packages/e8/62/6137b2d0b5d69e80004373fac8e84735c975b4a63d4bcab237012e6b486e/Markdown-3.3.5.tar.gz
...
%prep
%setup -q -n Markdown-3.3.5
cd %{_builddir}/Markdown-3.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637087769
...
cp %{_builddir}/Markdown-3.3.5/LICENSE.md %{buildroot}/usr/share/package-licenses/Markdown/686030b6b3298c011fe74266f0cde2d2c77f4a13
